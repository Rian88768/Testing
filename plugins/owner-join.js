...
Saya diundang oleh *${m.name}*`, m, {
    mentions: d
     ...
     await conn.reply(res, `untuk menampilkan menu ketik .menu`, 0)
...
*${conn.user.name}* adalah salah satu bot WhatsApp multi-perangkat yang dibangun dengan Node.js, *${conn.user.name}* hanya diundang oleh *${m.name}*
